...
The idea is to identify any notable differences between the measurements the pi's in two different room: my office, and the living room.  
...
Some of you might be asking: *Does it really get above 40 (104 degrees Fahrenheit) in your house???*  
...
1. Gravity effect is slightly lesser in one room than in the rest of the world, and  
2. Gravity's value occasionally jumps .6 G's.  
