...
The idea is to identify any notable differences between the measurements the pi's in two different room: my office, and the living room.  I've limited the results to those metrics which are of interest.  For a comprehensive and more interactive version of this report [click here](dailyReport.html)
...
Depending on the season, some of you might be asking: *Does it really get above 40 (104 degrees Fahrenheit) in your domicile???*  
...
1. Gravity's effect is slightly lesser in one room than in the rest of the world, and  
...
* There are notable gaps in data.  Why?    
   ...
   + Sometimes, the pi records a non-UTF character, and data ingestion fails.
